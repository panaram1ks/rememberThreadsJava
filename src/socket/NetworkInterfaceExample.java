...
public class NetworkInterfaceExample {
    public static void main(String[] args) {
        try {
            InetAddress address = InetAddress.getByName("192.168.1.61");

//1            NetworkInterface networkInterface = NetworkInterface.getByInetAddress(address);
//2            NetworkInterface networkInterface = NetworkInterface.getByName("enp2s0");
